      ...
      <div className="relative grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="space-y-5">
          <div>
            ...
            <h2 className="mt-3 text-xl uppercase tracking-[0.18em] text-zinc-200 sm:text-2xl">
              {title}
            </h2>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <input
              ...
              className="w-full border border-white/10 bg-black/65 px-4 py-3 text-sm text-zinc-200 outline-none transition focus:border-red-400/40"
            />
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <p className="flex items-center text-[0.7rem] uppercase tracking-[0.24em] text-zinc-600">
                {note}
              </p>
            </div>
          </form>

          <div className="space-y-1 border-t border-white/8 pt-4 text-[0.72rem] uppercase tracking-[0.24em]">
