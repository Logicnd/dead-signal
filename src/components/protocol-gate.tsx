...
export function ProtocolGate({
  ...
  return (
    <section className="relative overflow-hidden border border-white/10 bg-black/55 p-4 sm:p-5">
      ...
      <div className="relative grid gap-4 xl:grid-cols-[minmax(0,1fr)_15rem]">
        <div className="space-y-4">
          <div>
            <p className="text-[0.62rem] uppercase tracking-[0.34em] text-red-300/70">
              {badge}
            </p>
            <h2 className="mt-2 text-lg uppercase tracking-[0.12em] text-zinc-200 sm:text-xl">
              {title}
            </h2>
          ...
          <form className="max-w-2xl space-y-3" onSubmit={handleSubmit}>
            <input
              ...
              className="w-full border border-white/10 bg-black/65 px-3 py-2.5 text-sm text-zinc-200 outline-none transition focus:border-red-400/40"
            />
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <p className="flex items-center text-[0.66rem] uppercase tracking-[0.18em] text-zinc-600">
                {note}
              </p>
            </div>
          </form>

          <div className="space-y-1 border-t border-white/8 pt-3 text-[0.68rem] uppercase tracking-[0.18em]">
