...
export function SystemShell({
  ...
  return (
    <main className="relative isolate min-h-dvh px-3 py-4 sm:px-4 sm:py-6">
      ...
      <div className={`relative z-10 mx-auto w-full ${widthClasses[width]}`}>
        <div className="relative overflow-hidden border border-white/10 bg-black/70 shadow-[0_0_120px_rgba(255,72,32,0.08)] backdrop-blur-sm">
          ...
          <div className="absolute right-8 top-6 hidden text-right text-[0.72rem] uppercase tracking-[0.28em] text-zinc-700 sm:block">
            <p>ext relay 03</p>
          ...
          <div className="relative p-5 sm:p-7">
            <div className="flex items-start justify-between gap-6 border-b border-white/8 pb-5">
              <div>
                <p className="text-[0.72rem] uppercase tracking-[0.28em] text-red-400/80 signal-flicker">
                  residual intake
                </p>
                <p className="mt-2 text-[0.78rem] uppercase tracking-[0.18em] text-zinc-500">
                  {label}
                </p>
              </div>
              <div className="text-right text-[0.72rem] uppercase tracking-[0.22em] text-zinc-700 sm:hidden">
                <p>relay 03</p>
              </div>
            </div>
            ...
            {footer ? (
              <div className="mt-6 border-t border-white/8 pt-4 text-[0.68rem] uppercase tracking-[0.14em] text-zinc-600">
                {footer}
              </div>
            ) : null}
          </div>
